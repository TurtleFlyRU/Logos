...
В шапке окна (рядом с профилем) должна быть метка **`send-ui-20250520`**. Если её нет — вы смотрите **старый** интерфейс.
...
- Кнопки и slash: **Env**, **Контекст** (визуальный бюджет: сводка, шкала заполнения, слои с полосами, чипы system/history/tool, сворачиваемый полный `/budget` из sidecar; учитывается черновик в поле ввода), **Пайплайны**, **Boot**, **Сон**, **Настройки**, **Новая сессия**
...
**Следующие шаги (фаза 4+):** подсветка YAML в редакторе agents; тренды бюджета по сессии.
