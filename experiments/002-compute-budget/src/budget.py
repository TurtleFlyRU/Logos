...
_DEEP_VERBS = {
    "сравни", "сравнить", "сравнение", "сравнивать",
    "проанализируй", "проанализировать", "анализировать", "анализ",
    "спланируй", "спланировать", "планировать", "план",
    "синтезируй", "синтезировать", "синтез",
    "обобщи", "обобщить", "обобщать", "обобщение",
    "выведи", "вывести", "выводить", "вывод",
    "объясни", "объяснить", "объяснять", "объяснение",
    "рекурсивно", "итеративно",
    "оптимизируй", "оптимизировать", "оптимизация",
    "рефактори", "рефакторинг", "рефакторить",
    "спроектируй", "проектировать", "проект", "проектирование",
    "архитектура", "архитектуры", "архитектурой", "архитектуру",
    "архитектуре", "архитектурный",
    "закономерность", "закономерности", "паттерн", "паттерны",
    "инвариант", "инварианты",
    "compare", "analyze", "analysis", "plan", "planning",
    "synthesize", "synthesis", "generalize", "derive",
    "recursively", "iteratively", "optimize", "refactor",
    "design", "architecture", "explain", "explanation",
    "pattern", "patterns", "invariant", "invariants",
}

# Слова-маркеры ссылок на артефакты
_REF_MARKERS = {
    "файл", "файлы", "файла", "файлов",
    "class", "function", "метод", "методы", "метода", "модуль", "модуля",
    "эксперимент", "эксперимента", "экспериментов", "эксперименте",
    "память", "памяти", "памятью",
    "принцип", "принципа", "принципов", "принципы",
    "дневник", "журнал", "журнала",
    "записи", "запись", "записей", "раздел", "разделы",
    "найди", "найти", "поиск", "искать",
    "эпизод", "эпизоды", "эпизодов", "эпизодах",
    "подцель", "подцели", "подцелей",
    "file", "files", "module", "memory", "principle", "principles",
    "journal", "record", "records", "search", "find",
    "episode", "episodes", "experiment", "experiments",
}
